Due to Android security restrictions introduced in recent versions, it is no longer possible for apps to freely inspect the local network (for example by using ICMP ping or reading the ARP table).
